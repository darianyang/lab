...
# Read the CSV file
file_path = 'CA-CTD-MALS-filtered3.csv'
...
labels = ["WT CA-CTD: 200 $\mu$M", "WT CA-CTD: 10 $\mu$M", "T188C (RED): 200 $\mu$M", "T188C (RED): 10 $\mu$M",  "T188C (OX): 200 $\mu$M", "T188C (OX): 10 $\mu$M", "BSA: 200 $\mu$M", "BSA: 10 $\mu$M"]
colors = ['black', 'gray', 'blue', 'cornflowerblue', 'red', 'lightsalmon', 'darkgreen', 'lightgreen']
idx = 0
...
ax1.set_xlim(10.5,22.5)
ax1.set_ylabel('UV (Normalized Abs)')
#ax1.tick_params(axis='y', labelcolor='tab:blue')

ax2.set_ylabel('Molar Mass (Daltons)')
ax2.set_ylim(1000,500000)
# 9.95 kDa
ax2.axhline(9946, color="gray", linestyle="--")
ax2.text(11, 10500, "Theoretical Monomer")
# 19.9 kDa
ax2.axhline(9946*2, color="gray", linestyle="--")
ax2.text(11, 21000, "Theoretical Dimer")
#ax2.tick_params(axis='y', labelcolor='tab:red')
# BSA
ax2.axhline(66431, color="gray", linestyle="--")
ax2.text(11, 70000, "BSA")

# Add a legend
fig.legend(loc='upper right', bbox_to_anchor=(1.45,1), bbox_transform=ax1.transAxes, frameon=False)
...
plt.tight_layout()
#plt.savefig("SEC-MALS-4.pdf")
plt.savefig('SEC-MALS-4.pdf', bbox_inches='tight')
#plt.show()
